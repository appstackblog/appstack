(() => {
  const STYLE_ID = "ft-free-func-engine-style";
  ...
  function ensureStyles() {
    ...
    style.textContent = `
      ...
      .func-runtime-message-typing {
        ...
        animation: ftFreeRuntimeTyping 1.9s steps(9, end) infinite;
      }

      @keyframes ftFreeRuntimeTyping {
        0%,
        12% {
          width: 0ch;
        }
      ...
      .func-runtime-message-stopped {
        ...
        animation: ftFreeStoppedPulse 1.6s ease-in-out infinite;
      }

      @keyframes ftFreeStoppedPulse {
        0%,
        32%,
        100% {
          opacity: 1;
